...
export default function Alarm({title,time , removeItem}:IAllValues&{removeItem : RemoveItem}) {
    ...
    return <div className="flex m-5 border-2 border-white px-2  rounded-md border-r-2">
        ...
        <div className="flex gap-x-3 py-4 pr-4 font-bold pl-6">
            ...
            <button onClick={removeItem} className="px-2 py-1 border-2 border-white rounded-md hover:text-white shadow-blue-300/60 shadow-lg bg-redApp hover:bg-redApp/50">Delete</button>
        </div>
    </div>
}